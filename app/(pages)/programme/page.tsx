...
export default function Programme () {
    return (
        <div className="flex flex-col ">
             ...
             <div className="w-full py-[150px] px-[280px] h-[600px] text-white bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
                <h1 className="md:text-4xl text-2xl font-bold">Programme</h1>
            </div>


             <div className="flex flex-col space-y-20 py-20 px-4 md:px-0 items-center justify-center  bg-[#151853] text-white">
